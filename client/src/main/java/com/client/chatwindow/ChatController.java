...
public class ChatController implements Initializable {
    ...
    public synchronized void addToChat(Message msg) {
        Task<HBox> othersMessages = new Task<HBox>() {
            ...
            public HBox call() throws Exception {
                Image image = new Image(getClass().getResource("/images/default.png").toString());
    ...
    public void setImageLabel() throws IOException {
        this.userImageView.setImage(new Image(getClass().getResource("/images/dominic.png").toString()));
    }
    ...
    public void newUserNotification(Message msg) {
        Platform.runLater(() -> {
            Image profileImg = new Image(getClass().getResource("/images/default.png").toString(),50,50,false,false);
